...
export class ClaudeService {
    async analyzeArchitecture(index) {
...
Responde SOLO JSON con score, issues y recommendations.`;
    ...
    async analyzePerformance(index) {
...
//# sourceMappingURL=dimensionAnalyses.js.map