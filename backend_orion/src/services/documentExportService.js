...
export class DocumentExportService {
    advancedDiagram = new AdvancedDiagramService();
    /**
     ...
     */
    async processAllDiagrams(markdown, outputDir, baseName, options) {
        let diagramIndex = 0;
     ...
     */
    buildProfessionalHTML(params) {
        const { htmlContent, docTitle, docSubtitle, docVersion, currentDate, fullDate, year, showCover, showTOC, author, confidential, documentType, } = params;
...
<body>
  ...
  <div class="document-content">
     ...
     */
    getDocumentSubtitle(documentType) {
        const subtitles = {
